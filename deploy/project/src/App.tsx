									...
									<div className="relative bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden">
										...
										{!auth.isAuthenticated && (
											<div className="absolute top-2 right-2 flex gap-2">
												<div className="absolute top-2 right-2 p-2 bg-yellow-500 rounded-full shadow-md opacity-15 group-hover:opacity-100">
										...
										{auth.isAuthenticated && (
											<div className="absolute top-2 right-2 flex gap-2">
												<button
													...
													className="p-2 bg-white dark:bg-gray-800 rounded-full shadow-md opacity-30 group-hover:opacity-100 transition-opacity"
													title="Editar imagem"
												>
